...
public class MovieListView extends JPanel{
    ...
    private JButton btnAddMovie, btnDisplay;
    ...
    public void init(){
        ...
        btnAddMovie = new JButton("New Movie");
        btnDisplay = new JButton(">>");
        lblMovie = new JLabel("List of Movies");
        listMovie = new JList();
        lblTitle = new JLabel();
        lblDesc = new JLabel();
        lblGenre = new JLabel();
        ...
        lblMovie.setBounds(280, 10, 100, 20);  
        jspMovie.setBounds(10, 50, 300, 470);       
        btnAddMovie.setBounds(240, 550, 200, 30);
        btnDisplay.setBounds(310, 230, 70, 40);
        pnlDisplay.setBounds(380, 50, 255, 465);
